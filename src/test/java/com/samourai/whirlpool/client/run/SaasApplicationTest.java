...
import com.samourai.whirlpool.saas.SaasApplication;
...
@SpringBootTest
@Disabled
public class SaasApplicationTest extends AbstractApplicationTest {
  ...
  public void runListPools() {
    ...
    new SaasApplication().run(appArgs);
  ...
  public void runWhirlpool() {
    ...
    captureSystem();
    new SaasApplication().run(appArgs); // TODO mock server
    resetSystem();
